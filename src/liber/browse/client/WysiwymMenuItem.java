...
/**
 * A widget that can be placed in a WysiwymMenuBar. Menu items can either fire a
 * Command when they are clicked, or open a
 * cascading sub-menu.
 *
 *	@see com.google.gwt.user.client.ui.WysiwymMenuBar
 *	@see com.google.gwt.user.client.Command
 */

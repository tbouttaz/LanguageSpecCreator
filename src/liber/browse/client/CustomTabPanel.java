 ...
 * Composite that aggregates a TabBar and a DeckPanel. It does, however, implement
 * HasWidgets.
 * </p>
 * 
 ...
 *	@see com.google.gwt.user.client.ui.DeckPanel
 *	@see com.google.gwt.user.client.ui.HasWidgets
 */
public class CustomTabPanel extends Composite implements TabListener,
    SourcesTabEvents, HasWidgets, IndexedPanel {

  private WidgetCollection children = new WidgetCollection(this);
  private DeckPanel deck = new DeckPanel();
  private CustomTabBar tabBar = new CustomTabBar();
  ...
  public CustomTabPanel() {
	...
	public void setParentWidget(WYSIWYMinterface p)
	{
		parent = p;
	}

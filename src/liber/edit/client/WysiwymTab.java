...
public class WysiwymTab extends MyTab implements ClickListener
{
	...
	protected int type = WYSIWYMinterface.EDIT_TAB;	//session type
	protected int htmlIndex = 1;
	protected String key = null;	//session identifier
  	...
  	/**	Resets the editing session, displaying the class hierarchy again.
  	 */
  	public void reset()
  	{

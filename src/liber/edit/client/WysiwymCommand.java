...
{
	public static final int EDIT = 0;	//editing session
	public static final int QUERY = 2;	//querying session
	public static final int BROWSE = 4;	//browsing session
	...
	protected PopupPanel pp, tagCloudPP;
	protected Label l;
	...
	protected int buttonsPressed = 0;		//TEMPORARY, FOR EVALUATION EXPERIMENTS
		...
		{	//check property type on server
			public void onSuccess(Object o)
			{
				...
				{	//ensure that datatype is set so we can check whether values are integers/doubles
					...
					getAddedValues();	//and check if any values were added previously
				}
     ...
     */	
   	public void showTagCloud()
   	{
		...
		if (userID == null)
			return;
   		parent.getHandler().getTagCloud(userID, property, new AsyncCallback()
   		{
   			public void onSuccess(Object o)
   			{
    ...
    */
   	...
   	{
   		if (pp != null)
	   		return ((InputPopupPanel)pp).isShowing();
	   	return false;
   	}
